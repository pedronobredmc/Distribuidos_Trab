        ...
        try (ByteArrayInputStream bis = new ByteArrayInputStream(arguments);
            ...
            switch (methodId) {
                case "1": { // cadastrar veículo
                    ...
                    String resultado = "Veículo cadastrado: " + modelo + " - " + placa + " - " + ano;
                ...
                case "2": { // listar veículos
                    ...
                    return serializarResultado("Lista de veículos: \n" + lista.toString());
                }
                    ...
                    for (MeioDeTransporte veiculo : veiculos) {
                        ...
                        if (placaRegistrada.equals(placa)) {
                            ...
                            if (!alugueisAtivos.contains(placa)) {
                                ...
                                return serializarResultado("Veículo " + veiculo.getModelo() + " alugado por " + dias + " dias.");
                            } else {
                                return serializarResultado("Veículo " + placa + " já está alugado.");
                            }
                        }
                    }

                    if (!veiculoEncontrado) {
                        return serializarResultado("Veículo não encontrado.");
                    }
                    break;
                }
                ...
                case "4": { // remover veículo
                    ...
                    String resultado = "Veículo " + placa + " removido do sistema.";
                    return serializarResultado(resultado);
                }
